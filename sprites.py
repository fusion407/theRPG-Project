...
class Player(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.down_animations = [self.game.character_spritesheet.get_sprite(0, 1, self.width, self.height),
                           self.game.character_spritesheet.get_sprite(31, 1, self.width, self.height),
                           self.game.character_spritesheet.get_sprite(62, 1, self.width, self.height)]

        self.up_animations = [self.game.character_spritesheet.get_sprite(0, 34, self.width, self.height),
                         self.game.character_spritesheet.get_sprite(31, 34, self.width, self.height),
                         self.game.character_spritesheet.get_sprite(62, 34, self.width, self.height)]

        self.left_animations = [self.game.character_spritesheet.get_sprite(0, 65, self.width, self.height),
                           self.game.character_spritesheet.get_sprite(31, 65, self.width, self.height),
                           self.game.character_spritesheet.get_sprite(62, 65, self.width, self.height)]

        self.right_animations = [self.game.character_spritesheet.get_sprite(0, 96, self.width, self.height),
                            self.game.character_spritesheet.get_sprite(31, 96, self.width, self.height),
                            self.game.character_spritesheet.get_sprite(62, 96, self.width, self.height)]
    ...
    def animate(self):
        ...
        if self.facing == "up":
            if self.y_change == 0:
                self.image = self.game.character_spritesheet.get_sprite(0, 34, self.width, self.height)
            else:
        ...
        if self.facing == "left":
            if self.x_change == 0:
                self.image = self.game.character_spritesheet.get_sprite(0, 65, self.width, self.height)
            else:
...
class Block(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.image = self.game.terrain_spritesheet.get_sprite(994, 544, self.width, self.height)
...
class Treasure(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.image = self.game.treasure_spritesheet.get_sprite(0, 0, self.width, self.height)
